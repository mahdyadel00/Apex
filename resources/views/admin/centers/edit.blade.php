    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ __('dashboard.edit_center') }}</h3>
            </div>
                    ...
                    <div class="row push">
                        <div class="col-lg-12">
                                ...
                                <select name="lang_id" id="lang_id" class="form-control">
                                    ...
                                    @foreach ($languags as $lang)
                                        <option value="{{ $lang->id }}"
                                            {{ $center->data->first()->lang_id == $lang->id ? 'selected' : '' }}>
                                            {{ $lang->code }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="js-select2 form-control" id="state_id" name="state_id"
                                        style="width: 100%;" data-placeholder="Choose one..">
                                    <option></option>
                                    @foreach ($states as $state)
                                        <option value="{{ $state->id }}"
                                            {{ $center->state_id == $state->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="checkbox" id="is_active" name="is_active" placeholder="{{ __('dashboard.is_active') }}" value="1" {{ $center->is_active == 1 ? 'checked' : '' }}>
