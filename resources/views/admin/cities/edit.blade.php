    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ __('dashboard.edit_city') }}</h3>
            </div>
                ...
                <form action="{{ route('admin.cities.update', $city->id) }}" method="POST"
                    ...
                    <div class="row push">
                        <div class="col-lg-12">
                                ...
                                <select name="lang_id" id="lang_id" class="form-control">
                                    ...
                                    @foreach ($languags as $lang)
                                        <option value="{{ $lang->id }}"
                                            {{ $city->data->first()->lang_id == $lang->id ? 'selected' : '' }}>
                                            {{ $lang->code }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                <label class="form-label" for="state_id">{{ __('dashboard.country_name') }}</label>
