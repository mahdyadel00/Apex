    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ __('dashboard.edit_post') }}</h3>
            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="{{ __('dashboard.post_name') }}" value="{{ $post->title }}">
                                @if ($errors->has('title'))
                                    <span class="text-danger ">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="{{ __('dashboard.description') }}" rows="4">{{ $post->description }}</textarea>
