...
@section('content')
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.students.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                ...
                                <p class="fs-3 mb-0"> {{ $students->count() }}</p>
                            </div>
                            <div>
                                <i class="nav-main-link-icon fa fa fa-user"></i>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.appointments.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                  {{ __('dashboard.appointments') }}
                                </p>
                                <p class="fs-3 mb-0"> {{ $appointments->count() }}</p>
                            </div>
                            <div>
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.quizzes.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                  {{ __('dashboard.quizzes') }}
                                </p>
                                <p class="fs-3 mb-0"> {{ $quizzes->count() }}</p>
                            </div>
                            <div>
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.centers.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                    {{ __('dashboard.centers') }}
                                </p>
                                <p class="fs-3 mb-0"> {{ $centers->count() }} </p>
                            </div>
                            <div>
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.certificate_integrity.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                ...
                                <p class="fs-3 mb-0"> {{ $certificate_integrations->count() }}</p>
                            </div>
                            <div>
                                <i class="nav-main-link-icon fa fa-circle-info"></i>
                            </div>
               ...
               <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.step_systems.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                {{ __('dashboard.step_systems') }}
                                </p>
                                <p class="fs-3 mb-0"> {{ $step_systems->count() }}</p>
                            </div>
                            <div>
                                <i class="nav-main-link-icon fa fa-circle-info"></i>
                            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-pop" href="{{ route('admin.student_systems.index') }}">
                    <div class="block-content block-content-full">
                        <div class="d-flex align-items-center justify-content-between p-1">
                            <div class="me-3">
                                <p class="text-muted mb-0">
                                {{ __('dashboard.student_systems') }}
                                </p>
                                <p class="fs-3 mb-0"> {{ $student_systems->count() }}</p>
                            </div>
                            <div>
                                <i class="nav-main-link-icon fa fa-circle-info"></i>
                            </div>
