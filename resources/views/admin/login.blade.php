                                    ...
                                    <div
                                        ...
                                        <div class="mb-2 text-center">
                                            <a class="link-fx fw-bold fs-1" href="{{ route('home') }}">
                                                <span class="text-dark">{{ __('dashboard.qaysegp') }}</span>
                                            </a>
                                            <p class="text-uppercase fw-bold fs-sm text-muted">{{ __('dashboard.sign_in') }}</p>
                                        </div>
                                        <!-- END Header -->

                                        <!-- Sign In Form -->

                                        <form class="js-validation-signin" action="{{ route('admin.do.login') }}" method="post">
                                            @csrf
