...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    ...
    Route::get('edu-levels', [EduLevelController::class, 'index'])->name('edu-levels.index');
    ...
    Route::get('edu-years', [EduYearController::class, 'index'])->name('edu-years.index');
    ...
    Route::apiResource('assignments.students', AssignmentSubmissionController::class)
        ->only(['index'])
        ->parameters(['assignments' => 'assignment_id', 'submissions' => 'id']);

    // Assignment Type Group
    Route::get('assignment-types', [AssignmentTypeController::class, 'index'])
        ->name('assignment-types.index');
    ...
    Route::get('board-styles', [BoardStyleController::class, 'index'])->name('board-styles.index');
